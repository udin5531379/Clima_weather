...
//  Copyright (c) 2018 Udin Rajkarnikar. All rights reserved.
//
...
class WeatherViewController: UIViewController, CLLocationManagerDelegate, changeCityDelegate {
    ...
    //Write the getWeatherData method here: 3
    ...
    //Write the updateWeatherData method here: 4
    ...
    //Write the didUpdateLocations method here: //1
   func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
    ...
    //Write the didFailWithError method here: //2
